...
class HighScoreEntry:
    ...
    def from_dict(d: dict[str, Any]) -> "HighScoreEntry":
        """Deserialise from a JSON-decoded dict; missing keys default to 0/1."""
...
class HighScoreTable:
    ...
    def add(self, iq_score: int, stage_reached: int, raw_score: int) -> int:
    ...
    def _load(self) -> None:
        """Load persisted entries from browser localStorage; silent no-op on desktop."""
        try:
